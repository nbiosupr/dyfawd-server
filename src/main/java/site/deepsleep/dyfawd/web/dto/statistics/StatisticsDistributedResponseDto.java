...
@Getter
@NoArgsConstructor
public class StatisticsDistributedResponseDto {
    private Boolean isNationwide;
    private Boolean isMonthly;
    private Map<Integer, Map<String, List<SensorDataDto>>> results;

    @Builder
    public StatisticsDistributedResponseDto(Boolean isNationwide, Boolean isMonthly, Map<Integer, Map<String, List<SensorDataDto>>> results) {
